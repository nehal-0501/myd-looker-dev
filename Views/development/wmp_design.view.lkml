view: wmp_design {
  ...
  dimension: text_i_trade_i_GTV{
    type: string
    sql: "GTV EX GST" ;;
    html: <p style="color: #1971ED; font-family: Verdana; font-size:80%; text-align:center"> {{ rendered_value }}</p>;;
  }
  ...
  dimension: text_i_shipping_i_delivered_7_day{
    ...
    html: <p style="color: #1971ED; font-family: Verdana; font-size:100%; text-align:center"> {{ rendered_value }}</p>;;
  }
  ...
  dimension: text_i_your_metrics{
    type: string
    sql: "Your Metric" ;;
    html: <p style="color: #1971ED; font-family: Verdana; font-size:80%; text-align:center"> {{ rendered_value }} <img src="https://img.icons8.com/?size=100&id=jyznmXqzcrM0&format=png&color=000000" height=25 width=25 style="margin-right: 2px;"> </p>;;
  }

  dimension: logo_i_S_i_WMP{
    type: string
    sql: "" ;;
    html: <p style="font-size:80%; text-align:center"> <img src="https://drive.google.com/thumbnail?id=1D-K8MsxZMyP2OLa3JCoqdRjbsBR5trOg" height=25 width=75 style="margin-right: 2px;"> </p>;;
  }

  dimension: logo_i_S_i_BWM{
    type: string
    sql: "" ;;
    html: <p style="font-size:80%; text-align:center"> <img src="https://drive.google.com/thumbnail?id=1HCcARhGPFMIjzf0aH17G6AoiW6OxTGBr" height=50 width=50 style="margin-right: 2px;"> </p>;;
  }

  dimension: logo_i_S_i_EDM{
    type: string
    sql: "" ;;
    html: <p style="font-size:80%; text-align:center"> <img src="https://drive.google.com/thumbnail?id=1QmTSzIxC5IQqd9Wf_nNO8Md7z4774amI" height=65 width=65 style="margin-right: 2px; margin-top: 2px;"> </p>;;
  }

  dimension: logo_i_S_i_MYD{
    type: string
    sql: "" ;;
    html: <p style="font-size:80%; text-align:center"> <img src="https://drive.google.com/thumbnail?id=1hTwJ6Ew3JXUz_YE5J3CbaNSYUXMepppR" height=20 width=75 style="margin-right: 2px; margin-top: 2px;"> </p>;;
  }

  dimension: logo_i_S_i_EDRS{
    type: string
    sql: "" ;;
    html: <p style="font-size:80%; text-align:center"> <img src="https://drive.google.com/thumbnail?id=1deTNxdQ3QtcE6GSpVTwLqmJPaMvnskgF" height=25 width=75 style="margin-right: 2px; margin-top: 2px;"> </p>;;
  }
  ...
  measure: text_period{
    ...
    html:  <p style="color: #878787;font-family: Verdana; font-size:90%">{{ rendered_value }}</p>;;
  }
